...
class _HistoryScreenState extends State<HistoryScreen> {
  final String screenName = "Med Trips";
          ...
          child: Consumer<MedTripsBloc>(
            builder: (context,bloc,child){
             return ListView.separated(
                  itemCount: bloc.medTrips.length,
                  shrinkWrap: true,
                  ...
                  itemBuilder: (BuildContext context, int index) {
                    return AnimationListView(
                        ...
                        child: GestureDetector(
                            ...
                            child: rideHistory(bloc.medTrips[index])
                        )
                    );
                  }
              );
  ...
  Widget rideHistory(MedTrip trip){
    return Material(
      elevation: 5.0,
                ...
                children: <Widget>[
                  ...
                  Expanded(
                    ...
                    child: Column(
                      ...
                      children: <Widget>[
                        Text('${trip.doctorName} is ${trip.timeToArrive} away',
                          maxLines: 2,
